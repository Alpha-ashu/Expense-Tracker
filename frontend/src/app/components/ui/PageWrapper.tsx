...
interface PageWrapperProps {
    ...
    className?: string;
    /** If true, removes horizontal padding — use for full-bleed sections */
    noPadding?: boolean;
}

/**
 * Standard page wrapper — applied to every top-level page component.
 * Provides consistent:
...
export const PageWrapper: React.FC<PageWrapperProps> = ({ children, className, noPadding }) => (
    <div className={cn('w-full min-h-screen bg-gray-50 overflow-x-hidden', className)}>
        <div
            className={cn(
...
/**
 * Standard content section inside a page — provides consistent top spacing.
 */
