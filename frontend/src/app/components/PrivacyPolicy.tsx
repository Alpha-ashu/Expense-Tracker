...
export const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({
  ...
  const sections = [
    ...
    },
    {
      ...
      content: "Your data is used solely to provide and improve Kanakku services, including AI-powered financial insights, personalized budgeting, and secure data sync. We DO NOT sell your personal or financial information to third parties."
    },
    {
    ...
    },
    {
      ...
      content: "Kanakku operates with a local-first philosophy. This means your data is primary on your device, ensuring privacy even when you're not connected to the internet."
    }
  ];
      ...
      <div className="max-w-4xl mx-auto px-6 pt-40 lg:pt-52 pb-24">
        ...
        >
          ...
          <p className="text-gray-400 mb-8 max-w-md mx-auto">
            We believe privacy is a fundamental right. Kanakku is built from the ground up to be the most private financial tool you've ever used.
          </p>
